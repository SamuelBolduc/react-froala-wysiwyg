(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["FroalaEditorImg"] = factory(require("react"));
	else
		root["FroalaEditorImg"] = factory(root["React"]);
	    ...
	    value: function setNormalTagContent(firstTime) {
	      ...
	      if (firstTime) {
	        if (this.config.initOnClick) {
	          this.registerEvent(this.$element, 'froalaEditor.initializationDelayed', function () {
	            htmlSet();
	          });
	          this.registerEvent(this.$element, 'froalaEditor.initialized', function () {
	            _this2.editorInitialized = true;
	          });
	        } else {
	          this.registerEvent(this.$element, 'froalaEditor.initialized', function () {
	            _this2.editorInitialized = true;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FroalaEditorImg = function (_FroalaEditorFunction) {
	  _inherits(FroalaEditorImg, _FroalaEditorFunction);

	  function FroalaEditorImg() {
	    _classCallCheck(this, FroalaEditorImg);

	    return _possibleConstructorReturn(this, (FroalaEditorImg.__proto__ || Object.getPrototypeOf(FroalaEditorImg)).apply(this, arguments));
	  }

	  _createClass(FroalaEditorImg, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('img', { ref: 'el' });
	    }
	  }]);

	  return FroalaEditorImg;
	}(_FroalaEditorFunctionality2.default);

	exports.default = FroalaEditorImg;

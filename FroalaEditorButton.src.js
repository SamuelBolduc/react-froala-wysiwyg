...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FroalaEditorButton = function (_FroalaEditorFunction) {
	  _inherits(FroalaEditorButton, _FroalaEditorFunction);

	  function FroalaEditorButton() {
	    _classCallCheck(this, FroalaEditorButton);

	    return _possibleConstructorReturn(this, (FroalaEditorButton.__proto__ || Object.getPrototypeOf(FroalaEditorButton)).apply(this, arguments));
	  }

	  _createClass(FroalaEditorButton, [{
	    key: 'render',
	  ...
	  return FroalaEditorButton;
	}(_FroalaEditorFunctionality2.default);

	exports.default = FroalaEditorButton;

...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FroalaEditor = function (_FroalaEditorFunction) {
	  _inherits(FroalaEditor, _FroalaEditorFunction);

	  function FroalaEditor() {
	    _classCallCheck(this, FroalaEditor);

	    return _possibleConstructorReturn(this, (FroalaEditor.__proto__ || Object.getPrototypeOf(FroalaEditor)).apply(this, arguments));
	  }

	  _createClass(FroalaEditor, [{
	    key: 'render',
